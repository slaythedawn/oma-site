// "Types of work" cluster: category-explainer content, for people who know they
// want to model but have not decided which lane. Distinct from the how-to-walk
...
export const typesOfWork = [
  {
    slug: 'runway-model',
    seoTitle: 'What Is a Runway Model? The Real Job, Explained',
    description:
    ...
    headline: 'What Is a Runway Model? The Job, the Money and What It Actually Takes',
    category: 'Types of work',
    image: 'how-do-models-walk-in-runway-shows',
    imageAlt: 'A runway model mid-stride on a bare runway before a show',
    readTime: 10,
    date: DATE,
    related: [
    ...
    faq: [
      {
        q: 'What is a runway model?',
        a: 'A runway model is a model who works fashion shows, walking a runway to present a designer or brand\'s clothing to buyers, press and clients. It is a distinct discipline from print or commercial modeling, built around a specific walk, a specific body of sample sizes, and work that is booked in short, intense bursts around fashion weeks and trade shows.',
      },
      {
        q: 'Is it a "runway" or a "catwalk"?',
        a: 'Both terms describe the same thing. "Runway" is the more common term in the US, "catwalk" is more common in the UK and Australia, and the fashion industry uses them interchangeably. Neither is more correct than the other.',
      },
      {
        q: 'How tall do you have to be to be a runway model?',
        a: 'Most fashion and runway boards work with women from around 5\'9" and men from around 6\'0", because sample garments are cut to those proportions and a show needs a consistent silhouette across the line-up. It is a practical constraint about sample sizing, not a judgment about who looks good in clothes, and it is the single biggest reason runway has a narrower height range than commercial or fitness work.',
      },
      {
        q: 'Can you be a runway model if you are not that tall?',
        a: 'Not on a traditional fashion runway board, no. Below-height applicants who still want to work fashion shows generally move toward commercial runway (department store shows, trade shows, bridal, plus, petite lines), where the height rule loosens because the client\'s own sample sizing does. It is a different lane, not a lesser one, and it books consistently.',
      },
      {
        q: 'How much does a runway model make?',
        a: 'It varies more than almost any other category of modeling work. A single show for a major fashion week designer can pay more than several commercial bookings combined, while a department store or trade show slot typically pays a flat day rate. New faces often walk unpaid or for a modest flat fee to build a show reel, and pay rises sharply once an agency can point to a track record of shows actually walked. There is no single number that describes it honestly.',
      },
    ],
    body: `
<p>Ask someone outside the industry what a runway model does and they describe the walk: the stride, the turn, the blank stare down a lit strip of floor. That is the visible five percent of the job. The other ninety-five percent is what actually decides who gets booked, and almost nobody outside a casting room ever hears about it.</p>
<p>Here is what the job actually is, from the people who cast it.</p>
...
<p>Three things separate runway from most other modeling categories, and understanding them explains almost everything else about how the work is booked.</p>
<h3>The height and sample-size requirement</h3>
<p>Fashion runway boards work with a narrow height range, generally from around 5'9" for women and 6'0" for men, because designers cut sample garments to one set of proportions and a show needs a consistent silhouette across every look. This is not a taste judgment. It is a manufacturing constraint. A designer makes one sample per look, in one size, and fits every model in the show to it rather than making a dozen versions of the same garment.</p>
<p>Commercial, print, fitness, plus and parts work carry no comparable height rule, which is why most working models never touch runway and do not need to.</p>
<h3>The booking pattern</h3>
<p>Print and commercial work is booked more or less year-round. Runway is seasonal and concentrated: fashion weeks cluster into a few frantic weeks a year in a handful of cities, and most of a runway model's income for the season is earned in that window. Between seasons, many runway models work commercial or print jobs to fill the calendar, and agencies expect this.</p>
<h3>The casting-to-booking ratio</h3>
<p>Runway castings move fast and reject harder than almost any other category. A single show might see two or three hundred models walk for a casting director in a day for twenty or thirty confirmed spots. It is not personal, and it is rarely about how you looked. It is a fit exercise: does this specific person, in this specific sample garment, read the way the designer wants the whole line-up to read.</p>
...
<aside class="inline-cta">
  ...
  <a class="go" data-cta="inline-free" href="https://www.onlinemodel.academy/offers/ZbJFXeGn?utm_source=blog&utm_medium=article&utm_campaign=free_runway_module&utm_content=runway-model__inline" target="_blank" rel="noopener">Get the free module &rarr;</a>
</aside>
<h2>The Different Kinds of Runway Work</h2>
<p>"Runway model" gets used as one term for several distinct jobs, and knowing which one you are actually being booked for changes what to expect.</p>
<ul>
<li><b>Fashion week shows.</b> The top of the category: designer runway shows during New York, London, Milan, Paris and the regional fashion weeks. Height requirements are strictest here, competition is highest, and this is what most people picture when they hear "runway model."</li>
<li><b>Trade and market shows.</b> Shows run for buyers rather than the public or press, often less glamorous, often better and more reliably paid than a new face expects.</li>
<li><b>Department store and retail runway.</b> In-store fashion shows and events. Height requirements loosen considerably, and this is a genuine entry point for models who do not fit a traditional fashion board.</li>
...
<p>Height gets you considered. It does not get you booked. Inside the height range, casting directors are assessing something harder to describe: how a person moves, how they hold a garment, whether they read as the right energy for that specific collection. Our guide to <a href="../what-do-modeling-agencies-look-for/">what modeling agencies look for</a> covers this in more general terms; for runway specifically, three things matter beyond height and proportion.</p>
<ul>
<li><b>A consistent, controlled walk.</b> Not a dramatic one. Casting directors watch for a walk that will not fight the clothes, and that can be repeated identically look after look through a full show.</li>
<li><b>Fast, calm changes.</b> Backstage at a show is a small, crowded room and a strict clock. A model who can change into the next look, get re-styled and re-touched, and be back at the line in under two minutes without losing composure is worth more to a producer than a slightly better walk.</li>
<li><b>Professionalism under pressure.</b> Fittings get rearranged, running orders change an hour before doors, and a designer occasionally has a bad day two feet from your face. Agents talk to each other, and a reputation for being easy to work with in that environment travels fast in a small industry.</li>
</ul>

<h2>What the Money Actually Looks Like</h2>
<p>This is the question every new face asks and the one that has no single honest answer, because runway pay spans an unusually wide range even by modeling's standards.</p>
<p>A fashion week show for an established designer can be one of the better-paid bookings a model gets all year, and a single major show sometimes outpays several weeks of commercial castings combined. A department store or trade show slot, by contrast, typically pays a flat day rate that is respectable but unremarkable, closer to a solid day of commercial work than to a fashion week fee. New faces frequently walk their first shows for a modest flat fee, sometimes for exposure and a show reel rather than a meaningful cheque, because the show itself is the credential they need to book the next one.</p>
<p>What moves the number is track record, not talent alone. An agency can command a higher rate for a model who has already walked a season of shows without a problem than for an equally striking new face with nothing on their résumé yet. That is a large part of why the first year of runway work is about building a reliable, uneventful history rather than chasing the single biggest booking.</p>
<p>For the realistic costs of getting to that first booking, comps, agency submissions, travel for market weeks, see our guide to <a href="../how-much-does-it-cost-to-become-a-model/">what it actually costs to become a model</a>.</p>

<h2>If You Do Not Fit the Height Requirement</h2>
<p>This is the single most common reason a new applicant is told runway is not the right lane, and it is worth being straightforward about it. Traditional fashion runway boards are built around one narrow proportion range because of how samples are cut. That is not going to change for an individual applicant, however strong their look is otherwise.</p>
<p>It also is not the end of runway as an option. Commercial runway, retail and department store shows, bridal and plus-size runway all run on their own sizing standards and their own casting circuits, and they book consistently, year round, with far less competition for each spot than a fashion week casting sees. Many models build a long, working runway career entirely inside those lanes without ever walking a fashion week show, and are paid reliably for it.</p>

<h2>How to Actually Get Started</h2>
<p>Runway is not usually a first booking. Most agencies want to see a model handle a few commercial or print jobs first, both to build confidence in front of a camera and a crowd, and to confirm the basics before putting them in front of a casting director with two hundred other people in the room and thirty seconds to make a decision.</p>
<p>If runway is the goal, the practical path looks like this:</p>
<ol>
...
`,
...

  {
    ...
    headline: 'What Is Commercial Modeling? The Job, the Pay and How It Actually Works',
    category: 'Types of work',
    image: 'how-to-become-a-model',
    imageAlt: 'A model giving a natural, approachable smile for a commercial photography test shot against a plain studio wall',
    readTime: 10,
    date: '2026-08-25',
    related: ['runway-model', 'how-much-do-models-make', 'what-do-modeling-agencies-look-for'],
    faq: [
      {
        q: 'What is commercial modeling?',
        a: 'Commercial modeling is modeling used to sell a product, service or brand rather than to present fashion itself: catalogues, e-commerce, advertising, lifestyle and brand campaigns. It books on relatability and range rather than the narrow proportions fashion runway requires, which is why it employs far more working models than fashion does.',
      },
      {
        q: 'What is the difference between commercial and fashion modeling?',
        a: 'Fashion modeling sells the clothing itself and books to a narrow height and sample-size range. Commercial modeling sells whatever the client is selling, and the model is cast to look like the customer buying it, so the height, age and look requirements are far broader. A commercial casting brief is usually written around a real-life persona; a fashion casting is written around a garment.',
      },
      {
        q: 'How do you get into commercial modeling?',
        a: 'Shoot simple, natural digitals that show your real, relaxed range of expressions, submit them to agencies with a commercial or lifestyle board, and expect your first bookings to be smaller local or regional jobs rather than a national campaign. Commercial has the lowest entry barrier of any category, and the biggest one is comfort in front of a camera rather than a physical requirement.',
      },
      {
        q: 'What are examples of commercial modeling?',
        a: 'Catalogue and e-commerce product shots, lifestyle photography for brand websites and social ads, print and digital advertising, corporate and tech marketing imagery, food and hospitality campaigns, and hand or parts work for product close-ups. Almost any photograph used to sell something that features a person is commercial work.',
      },
      {
        q: 'Does commercial modeling pay well?',
        a: 'Individual bookings are typically smaller than a fashion week show, but usage is where the real money sits: a client licensing a photo for a year of national advertising pays far more than the same shoot used only on one product page. A working commercial model who books consistently often earns more reliably over a year than a fashion model who books rarely but well. See our guide to what models actually make for the full pay structure.',
      },
    ],
    body: `
<p>Ask most people to picture a model and they picture fashion: the runway, the towering height, the look agencies reject nine applicants out of ten for. That is a real category, and it is also a small one. Most working models, most days, are not doing that. They are doing commercial work: the catalogue shot, the lifestyle ad, the face on a shampoo bottle or a banking app's homepage. It employs more models, books more often, and is where most people who make a real income from modeling actually earn it.</p>
<p>Here is what the job is, from the people who cast it.</p>

<h2>What Commercial Modeling Actually Is</h2>
<p>Commercial modeling is modeling used to sell something other than the clothes on your back. A client, a brand, a retailer, an agency, needs a photograph or video of a person to sell a product, a service or an idea, and books a model to be that person. The distinction that matters is intent: fashion modeling exists to present the garment, commercial modeling exists to sell whatever the client is selling, and the model's job is to make a stranger want it, trust it, or picture themselves using it.</p>
<p>That single difference in intent changes almost everything else about the category: who gets booked, what a casting brief looks like, and how the work is paid.</p>

<h2>How Commercial Differs From Fashion Modeling</h2>
<p>Three things separate the two, and understanding them explains most of the confusion beginners have about which lane they actually fit.</p>
<h3>What is being sold</h3>
<p>A fashion casting is written around a garment: a designer needs a specific silhouette to carry a specific collection, so the brief is built from sample sizing outward. A commercial casting is written around a customer: a brand needs someone who looks like the person who buys their product, so the brief is built from the target buyer outward. A retirement fund ad, a college textbook site and a sneaker drop are selling to three completely different people, and each will cast a model who resembles that person, not a fashion-industry ideal.</p>
<h3>Who qualifies</h3>
<p>Fashion runway works within a narrow height and proportion range because sample garments are cut to one set of measurements. Commercial has no comparable universal rule, because there is no universal product. A casting for a grandparent in a pharmacy ad, a casting for a teenager in a phone case ad, and a casting for a construction worker in a tool brand's campaign all book completely different bodies, ages and looks, and all three are commercial work. This is the single biggest reason commercial employs so many more working models than fashion: the range of what "books" is genuinely wide, rather than narrow with rare exceptions.</p>
<h3>How the work is judged</h3>
<p>A fashion casting director is judging whether you disappear into the clothes and carry a specific walk or silhouette. A commercial casting director is judging something closer to relatability on camera: can you look natural rather than posed, can you convey a specific, ordinary emotion, warmth, mild surprise, quiet competence, on command and repeatably, and do you read as a real person a stranger would trust. It is a different skill from a runway walk, and it is arguably harder to fake, because the entire brief is "look like you are not performing."</p>
...
<ul>
<li><b>Catalogue and e-commerce.</b> The product shots on a retailer's own site: on-model apparel, accessories, homeware. High volume, steady demand, and usually the easiest entry point for a new face. Our <a href="../ecommerce-modeling/">dedicated guide to ecommerce modeling</a> covers this lane on its own, including how it differs from a <a href="../how-to-become-a-print-model/">printed catalogue</a> or a campaign shoot.</li>
...
<li><b>UGC-style content.</b> Video and photos built to look like an unscripted, native post rather than a produced ad, shot for the brand's own paid ad account or product page rather than a personal feed. Our <a href="../how-to-become-a-ugc-model/">dedicated guide to becoming a UGC model</a> covers this lane, including how the pay structure differs from the rest of commercial work.</li>
...
<h2>Who Actually Gets Booked</h2>
<p>The honest answer is: whoever the brief calls for, which is a far wider group than fashion ever considers. There is no universal height, age or size requirement across commercial work, because the category itself has no single client. What consistently matters, across almost every commercial brief, is different from what fashion asks for:</p>
<ul>
<li><b>A natural, repeatable expression.</b> The specific skill of looking relaxed and unposed on command, take after take, is trainable and it is the single most valuable thing a commercial model brings to a shoot.</li>
<li><b>Range.</b> A model who can read as a parent, a professional, a student or a retiree with a change of styling books more often than one with a single strong look, because it makes them useful across more briefs.</li>
<li><b>Reliability on set.</b> Commercial shoot days are often tightly scheduled around a client's production budget. A model who takes direction quickly and delivers consistent takes without needing dozens of retries is genuinely worth more to a producer than a slightly better-looking model who does not.</li>
</ul>
<p>This is also why commercial is, by a wide margin, the most accessible entry point into the industry, and it is the category our guide for <a href="../how-to-become-a-model-with-no-experience/">getting started with no experience</a> points most beginners toward first.</p>

<h2>How Commercial Pay Actually Works</h2>
<p>The day rate on a commercial booking is only half the number that matters. The other half is usage: what the client is allowed to do with the images afterward, and for how long.</p>
<p>A local retailer licensing a single photo for one product page pays a modest fee. A national brand licensing the same kind of photo for a year of paid social advertising, billboards and TV pays a multiple of that, sometimes a large one, because they are buying the right to put your face in front of millions of people repeatedly rather than once. This is the single most common thing new commercial models get wrong when they read a contract: the day rate looks small next to a runway fee, and the usage line is where the real money, and the real risk of underpricing yourself, actually sits.</p>
<p>We cover the full pay structure, day rates, usage, agency commission and realistic ranges by category, in <a href="../how-much-do-models-make/">how much do models actually make</a>. The short version for commercial specifically: it rarely produces a single spectacular payday the way a fashion week show occasionally can, but a model who books consistently across catalogue, lifestyle and advertising work tends to build a steadier, more reliable income over a full year than most fashion-only careers manage.</p>

<h2>How to Actually Get Into Commercial Modeling</h2>
<ol>
<li><b>Shoot simple, natural digitals.</b> Commercial casting directors are looking for how you read unposed, not how well you can pose. Bright, simple, undramatic photos that show a real range of natural expressions outperform a heavily styled portfolio every time. Our guide to <a href="../how-to-make-a-modeling-portfolio/">building a modeling portfolio</a> covers exactly what to shoot.</li>
<li><b>Submit to agencies with a commercial or lifestyle board.</b> Not every agency runs one, and some specialise in it entirely. Ask directly, and read our guide to <a href="../how-to-choose-a-modeling-agency/">choosing a modeling agency</a> before you sign with anyone.</li>
<li><b>Expect to start small.</b> Local retailers, regional campaigns and smaller e-commerce clients before a national brand. This is the normal shape of a commercial career building, not a sign of a weak start.</li>
<li><b>Practise looking unposed on command.</b> It is a genuine, trainable skill, not a personality trait you either have or do not. Casting directors can tell within seconds whether an expression is real or performed.</li>
<li><b>Read the usage line before you sign anything.</b> A commercial contract's value lives in what the client can do with the photos and for how long, not just in the day rate on the call sheet.</li>
</ol>
...
<p>A real, specialist niche: close-up work for product photography, jewelry, cosmetics and skincare. Small client pool, repeat bookings, and consistently underrated pay per hour. Covered in full in <a href="../how-to-become-a-hand-model/">how to become a hand model</a>, <a href="../how-to-become-a-foot-model/">how to become a foot model</a>, <a href="../how-to-become-a-leg-model/">how to become a leg model</a> and <a href="../how-to-become-a-lip-model/">how to become a lip model</a>.</p>

<h3>Face</h3>
<p>A parts-board niche in its own right, not a beauty category: skincare, dermatology, dental, eyewear, jewelry and haircare-packaging clients who need a face in frame without needing a hand, foot or full figure, cast on skin clarity and a calm, repeatable expression rather than a look. It gets confused with beauty modeling because both use a tight close crop, but the two are judged on close to opposite things. See our <a href="../how-to-become-a-face-model/">guide to becoming a face model</a> for what the casting is actually looking for.</p>
...
<li><b>Showroom and fit work.</b> Private fittings and presentations for buyers and press, without a live audience or a runway. Less visible than the other three, steady, and a genuine way into a design house's roster. Our dedicated <a href="../how-to-become-a-showroom-model/">showroom model guide</a> covers what the job actually is and how to get booked into it.</li>
</ul>
