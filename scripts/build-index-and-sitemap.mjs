...
const CLUSTERS = [
  ...
  },
  {
    ...
    slugs: ['modeling-jobs', 'open-casting-call', 'model-casting-calls', 'how-do-models-walk-in-runway-shows', 'what-is-fashion-modeling', 'runway-model', 'what-is-commercial-modeling', 'ecommerce-modeling'],
  },
  {
    heading: 'Training',
